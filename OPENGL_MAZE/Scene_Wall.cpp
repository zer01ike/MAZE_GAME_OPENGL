...
Scene_Wall::Scene_Wall(string & texture_path, string & framget_path, string & vertex_path)
{
	this->add_shader(framget_path, vertex_path);
	this->add_single_texture(texture_path);
}

Scene_Wall::Scene_Wall(std::vector<string> texture_paths, string & framget_path, string & vertex_path)
{
	this->add_shader(framget_path, vertex_path);
...
void Scene_Wall::render_Scene(glm::mat4 view, glm::mat4 projection, glm::mat4 model)
{
